...
def build_system_prompt(request_type: str) -> tuple[str, int]:
    ...
    if request_type == "care":
        ...
        system_prompt = (
            ...
            "и декоративных. 2–3 новых сорта (2020–2026) с краткой "
            "характеристикой. Для комнатных ПРОПУСТИ.\n\n"
            "ЖЁСТКИЕ ТРЕБОВАНИЯ:\n"
            ...
            "4. Не более 4000 символов. Без вступлений и заключений.\n"
            ...
            "## Перспективные сорта\n"
            "- **Санька** — ультраранний, устойчив к фитофторозу.\n"
    ...
    if request_type == "pests":
        ...
        system_prompt = (
            ...
            "3 сорта этой культуры, устойчивых к основным вредителям. "
            ...
            "4. Не более 4000 символов. Без вступлений.\n"
    ...
    if request_type == "diseases":
        ...
        system_prompt = (
            ...
            "## Устойчивые сорта — ТОЛЬКО для овощных, ягодных, плодовых. "
            "3 сорта, устойчивых к основным болезням. Для декоративных и "
            "комнатных ПРОПУСТИ.\n\n"
            "ЖЁСТКИЕ ТРЕБОВАНИЯ:\n"
            ...
            "## Устойчивые сорта\n"
            "- **Батяня** — комплексная устойчивость к фитофторозу и кладоспориозу.\n"
